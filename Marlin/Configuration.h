 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 400, 400, 400, 97 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 45, 35, 13, 25 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 10, 0, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define HOMING_FEEDRATE_MM_M { (40*60), (30*60), (9*60) }
